# kinematics_toolbox
The "MATLAB Toolbox for 3D Kinematics" is a library for scientific data analysis, with a focus on 3d kinematics.

It is hosted under https://github.com/thomas-haslwanter/kinematics_toolbox, and contains programs for
